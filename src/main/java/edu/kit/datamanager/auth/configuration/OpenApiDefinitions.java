...
public class OpenApiDefinitions{
  ...
  public OpenAPI customOpenAPI(){
    return new OpenAPI()
            ...
            .info(new Info().title("Authentication Microservice - RESTful API").
                    description("This webpage describes the RESTful interface of the KIT Data Manager Authentication Microservice.").
                    version("0.1").
                    contact(
                            new Contact().
